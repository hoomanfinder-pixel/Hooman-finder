      ...
      <main className="mx-auto max-w-6xl w-full px-4 py-10 flex-1">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-[#C7D4BB] bg-white shadow-sm">
          ...
          <div className="relative px-6 py-12 md:px-12 md:py-14">
            <div className="max-w-3xl">
              <h1 className="font-['Fraunces',serif] text-4xl md:text-5xl font-semibold tracking-tight text-[#0F2742]">
                About Hooman Finder
              </h1>
              ...
              <div className="mt-7 flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-[#0F2742] px-7 py-3 text-sm font-semibold text-[#F3C982] hover:bg-[#0C1E35]"
                >
                  Start matching
                </button>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-white px-7 py-3 text-sm font-semibold text-[#0F2742] border border-[#C7D4BB] hover:bg-[#EFE8DC]"
                >
                  Browse example dogs
                </button>
        ...
        <section className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-[#C7D4BB] bg-white p-6 shadow-sm">
            <h2 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">Why this matters</h2>
          ...
          <div className="rounded-2xl border border-[#C7D4BB] bg-white p-6 shadow-sm">
            <h2 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">Our mission</h2>
            <p className="mt-3 text-[#6F6A66] leading-relaxed">
          ...
          <div className="rounded-2xl border border-[#C7D4BB] bg-white p-6 shadow-sm">
            <h2 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">Why I started it</h2>
            <p className="mt-3 text-[#6F6A66] leading-relaxed">
            ...
            <div className="mt-4 rounded-xl bg-[#EFE8DC] border border-[#C7D4BB] p-3 text-sm text-[#6F6A66]">
              <span className="font-semibold text-[#0F2742]">Founder:</span>{" "}
              Lauren Breukink
            </div>
          </div>
        </section>
        ...
        <section className="mt-8 rounded-3xl border border-[#C7D4BB] bg-white p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <h3 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              onClick={() => navigate("/quiz")}
              className="inline-flex items-center justify-center rounded-full bg-[#0F2742] px-6 py-2.5 text-sm font-semibold text-[#F3C982] hover:bg-[#0C1E35]"
            >
              Take the quiz
            </button>
            ...
            <button
              onClick={() => navigate("/")}
              className="inline-flex items-center justify-center rounded-full bg-white px-6 py-2.5 text-sm font-semibold text-[#0F2742] border border-[#C7D4BB] hover:bg-[#EFE8DC]"
            >
              Back to home
            </button>
          </div>
