  ...
  return (
    <div className="min-h-screen bg-[#EAF7F0]">
      <div className="mx-auto w-full max-w-3xl px-4 py-8 md:py-10">
        ...
        {/* ✅ Fix mobile overflow: stack on mobile, row on desktop */}
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between md:gap-4">
          ...
          {/* ✅ Remove whitespace-nowrap (this was causing clipping) */}
        ...
        {/* ✅ Mobile-friendly bottom bar (stacks on mobile) */}
        <div className="mt-10 bg-white rounded-2xl shadow-sm p-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            {mode === QUIZ_MODES.DEALBREAKERS ? (
              <button
                className="w-full sm:w-auto px-4 py-2 rounded-xl border border-gray-300 bg-white text-gray-900"
                onClick={goRefine}
              >
                Refine (optional)
              </button>
            ...
            <button
              className="w-full sm:w-auto px-4 py-2 rounded-xl bg-green-700 text-white"
              onClick={goResults}
            >
              See my matches
            </button>
