    ...
    <div className="min-h-screen bg-[#F5F1E9] font-['Inter',sans-serif] text-[#0F2742] flex flex-col">
      ...
      <main className="mx-auto max-w-3xl w-full px-4 py-10 flex-1">
        ...
        <div className="mt-6 space-y-6 rounded-2xl border border-[#C7D4BB] bg-white p-6 text-[#6F6A66] shadow-sm">
          <section>
            <h2 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">Use of the Site</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">Adoption Information</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-['Fraunces',serif] text-lg font-semibold text-[#0F2742]">No Official Authority</h2>
            <p className="mt-2">
