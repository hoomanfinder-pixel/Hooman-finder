      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-slate-200">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {/* Hide About on tiny screens to prevent header squeeze */}
            <Link
              to="/about"
            ...
            <Link
              to="/saved"
              className="inline-flex items-center justify-center rounded-full bg-white px-4 sm:px-5 py-2.5 text-sm font-semibold text-slate-900 border border-slate-300 hover:bg-slate-50 whitespace-nowrap"
            >
              Saved
            </Link>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-4 py-10">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="relative px-6 py-12 sm:py-14 md:px-12 md:py-16 text-center">
              {/* Demo pill */}
