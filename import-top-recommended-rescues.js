...
const TARGET_RESCUES = [
  {
    ...
    city: "Coldwater",
    state: "MI",
    website: "https://projecthoperescue.org",
    applyUrl: "https://projecthoperescue.org",
  },
  {
    orgId: "6843",
    ...
    city: "Frankenmuth",
    state: "MI",
    website: "https://savingtailsanimalrescue.org",
    applyUrl: "https://savingtailsanimalrescue.org",
  },
  {
    orgId: "6172",
    ...
    city: "Clarkston",
    state: "MI",
    website: "https://www.ccrcdogs.com",
    applyUrl: "https://www.ccrcdogs.com",
  },
  {
    orgId: "5470",
    ...
    city: "Marine City",
    state: "MI",
    website: "https://www.luvumallanimalrescue.com",
    applyUrl: "https://www.luvumallanimalrescue.com",
  },
];
...
function parseAgeYearsFromText(ageText) {
  ...
  if (text.includes("puppy") || text.includes("baby")) return 0;
...
function normalizeAgeYears(animal) {
  ...
  const ageText =
    attr(animal, "ageString") || attr(animal, "ageGroup") || attr(animal, "age") || "";
  const parsed = parseAgeYearsFromText(ageText);
